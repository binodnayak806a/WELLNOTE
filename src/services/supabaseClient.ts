...
// import { supabase } from '@/lib/supabase'; // <<< CORRECT: Import the single client instance
// import { useAuthStore } from '@/store/auth';
// import type { Database } from '@/types/database';
// import {
//   appointmentService,
...
//   masterService,
//   patientService,
// } from './'; // Keep your existing service imports
...
//     console.warn('Attempted to query without a hospital ID.');
//     // Returning a query that resolves to null or empty array to prevent data leakage
//     return {
//       ...query,
//       then: (resolve: any) => resolve({ data: null, error: { message: 'Hospital ID is required', code: '401' } })
//     };
//   }
...
//   constructor(hospitalId?: string) {
//     const id = hospitalId || getCurrentHospitalId();
//     if (!id) {
//       throw new Error('Hospital ID is required for tenant operations');
//     }
//     this.hospitalId = id;
...
//   // Generic select with tenant isolation
//   select<T extends TableName>(table: T, columns: string = '*') {
//     return withTenant(supabase.from(table).select(columns), this.hospitalId)
//   }

//   // Generic insert with automatic hospital_id injection
//   insert<T extends TableName>(table: T, data: Omit<TableInsert<T>, 'hospital_id' | 'created_by'> | Omit<TableInsert<T>, 'hospital_id' | 'created_by'>[]) {
...
//     const insertData = Array.isArray(data) 
//       ? data.map(item => ({ ...item, ...commonData }))
//       : { ...data, ...commonData };
    
//     return supabase.from(table).insert(insertData as any);
//   }

//   // Generic update with tenant isolation and automatic updated_by injection
//   update<T extends TableName>(table: T, data: Omit<TableUpdate<T>, 'updated_by'>) {
//     const userId = getCurrentUserId();
//     const updateData = {
//       ...data,
//       updated_by: userId,
...
//     return withTenant(supabase.from(table).update(updateData as any), this.hospitalId)
//   }
...
// // Re-export all your services to be used in the app
// export {
//   patientService,
//   doctorService,
//   appointmentService,
